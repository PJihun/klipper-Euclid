...
static double
pythagoras_calc_belt_length(double x, double y, double pulley_x, double pulley_y
                            , double pulley_r, double tip_r)
{
...
int __visible
pythagoras_calc_xy(double target_a, double target_b
                   ...
                   , double *x_out, double *y_out)
{
    ...
    for (int i = 0; i < max_iter; i++) {
        ...
        double eps = 1.0e-6;
        double a_dx = pythagoras_calc_belt_length(
            x + eps, y, a_x, a_y, a_r1, a_r2);
        double b_dx = pythagoras_calc_belt_length(
            x + eps, y, b_x, b_y, b_r1, b_r2);
        double a_dy = pythagoras_calc_belt_length(
            x, y + eps, a_x, a_y, a_r1, a_r2);
        double b_dy = pythagoras_calc_belt_length(
            x, y + eps, b_x, b_y, b_r1, b_r2);
